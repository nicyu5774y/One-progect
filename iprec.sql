...
CREATE TABLE `ip` (
  ...
  `server8` text NOT NULL,
  `server9` text NOT NULL,
  `server10` text NOT NULL,
  `server11` text NOT NULL,
  `server12` text NOT NULL,
  `server13` text NOT NULL,
  `server14` text NOT NULL,
  `server15` text NOT NULL,
  `server16` text NOT NULL,
  `server17` text NOT NULL,
